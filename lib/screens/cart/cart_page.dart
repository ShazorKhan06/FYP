                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              BigText(text: "\Rs\t "+cartController.getCarts[index].price.toString(), color: Colors.redAccent),
                                              SizedBox(width: Dimensions.padding10,),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        SizedBox(width: Dimensions.padding10),
                        GetBuilder<CartController>(builder: (_){
                          return BigText(text: "\Rs\t "+ Get.find<CartController>().totalAmount.toString(), color: AppColors.mainBlackColor);
                        },),
                        SizedBox(width: Dimensions.padding10),
                      ],
                    ),
