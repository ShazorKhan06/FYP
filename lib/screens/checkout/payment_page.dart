            ...
            child: Stack(
              children: [
                ...
                _isLoading
                    ...
                    : SizedBox.shrink(),
                // Adding the centered button
                Align(
                  alignment: Alignment.bottomCenter, // Aligns the button at the bottom center
                  child: Padding(
                    padding: EdgeInsets.only(bottom: 50.0), // Adds padding from the bottom
                    child: ElevatedButton(
                      onPressed: () {
                        // Navigate to the Order Success Page
                        Get.toNamed(RouteHelper.getOrderSuccessRoute(widget.orderModel.id.toString(), 'success'));
                      },
                      style: ElevatedButton.styleFrom(
                        primary: AppColors.mainColor, // Sets the background color to AppColors.mainColor
                      ),
                      child: Text("I WANT TO CASH ON DELIVERY"),
                    ),
                  ),
                ),
              ],
